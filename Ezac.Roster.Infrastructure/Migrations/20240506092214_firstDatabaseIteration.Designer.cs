...
namespace Ezac.Roster.Infrastructure.Migrations
{
    ...
    [Migration("20240506092214_firstDatabaseIteration")]
    partial class firstDatabaseIteration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DayPeriodJob", b =>
                {
                    b.Property<Guid>("DayperiodsId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("JobsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("DayperiodsId", "JobsId");

                    b.HasIndex("JobsId");

                    b.ToTable("DayPeriodJob");
                });
            ...
            modelBuilder.Entity("DayPeriodJob", b =>
                {
                    b.HasOne("Ezac.Roster.Domain.Entities.DayPeriod", null)
                        .WithMany()
                        .HasForeignKey("DayperiodsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ezac.Roster.Domain.Entities.Job", null)
                        .WithMany()
